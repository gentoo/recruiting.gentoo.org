...
(function() { this.JST || (this.JST = {}); this.JST["projects/index"] = (function(context) {
    return (function() {
      var $c, $e, $o;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<tr class='" + ($e($c(this.klazz))) + "' title='Click to show subprojects' style='cursor: pointer' data-prjid='" + ($e($c(this.id))) + "'>\n  <td>" + ($e($c(this.name))) + "</td>\n  <td>" + ($e($c(this.team["leaders"]))) + "</td>\n  <td>" + ($e($c(this.team["members"]))) + "</td>\n  <td>" + ($e($c(this.description))) + "</td>");
  if (can_apply) {
    $o.push("  <td>\n    <a class='btn btn-mini' href='/projects/" + ($e($c(this.id))) + "/apply' data-method='put' title='Apply to this project' rel='tooltip'>\n      <i class='icon-book'></i>\n      <i class='icon-trophy'></i>\n    </a>\n  </td>");
      }
      $o.push("</tr>");
...
(function() { this.JST || (this.JST = {}); this.JST["shared/alert"] = (function(context) {
    return (function() {
      var $c, $e, $o;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
...
(function() {
  ...
  Gentoo.Models.Project = (function(_super) {
...
(function() {
  ...
  Gentoo.Collections.Projects = (function(_super) {
    ...
    Projects.prototype.url = "/projects/subprojects";

    Projects.prototype.model = Gentoo.Models.Project;
...
(function() {
  ...
  Gentoo.Views.ProjectsIndex = (function(_super) {
    __extends(ProjectsIndex, _super);

    function ProjectsIndex() {
      return ProjectsIndex.__super__.constructor.apply(this, arguments);
    }

    ProjectsIndex.prototype.template = JST['projects/index'];

    ProjectsIndex.prototype.alertTemplate = JST['shared/alert'];

    ProjectsIndex.prototype.el = "#projects";

    ProjectsIndex.prototype.initialize = function() {
      return this.subprojects = {};
    };

    ProjectsIndex.prototype.events = {
      "click tr": "load_subprojects"
    };

    ProjectsIndex.prototype.render = function() {
      this.collection.each((function(_this) {
        return function(prj) {
          return $(_this.el).append(_this.template(prj.toJSON()));
        };
      })(this));
      return this;
    };

    ProjectsIndex.prototype.load_subprojects = function(e) {
      var node, projectId, subs;
      node = $(e.currentTarget);
      projectId = node.attr("data-prjid");
      if ((subs = this.subprojects[projectId + ""]) != null) {
        return subs.each((function(_this) {
          return function(sub) {
            var subsubs;
            if ((subsubs = _this.subprojects[sub.id + ""]) != null) {
              subsubs.each(function(subsub) {
                return $("tr[data-prjid=" + subsub.id + "]").hide();
              });
            }
            return $("tr[data-prjid=" + sub.id + "]").toggle();
          };
        })(this));
      } else {
        this.subprojects[projectId + ""] = new Gentoo.Collections.Projects;
        return this.subprojects[projectId + ""].fetch({
          data: {
            parent_id: projectId
          },
          success: this.render_subprojects(node)
        });
      }
    };

    ProjectsIndex.prototype.render_subprojects = function(prj) {
      return (function(_this) {
        return function(prjs) {
          var a;
          if (prjs.length === 0) {
            a = _this.alertTemplate({
              message: "No subjects found."
            });
            $(".page-header").before(a);
            $(".alert").fadeOut(2000);
          }
          return prjs.each(function(p) {
            if (prj.hasClass("sub-project")) {
              p.set("klazz", "sub-sub-project");
            } else {
              p.set("klazz", "sub-project");
            }
            return prj.after(_this.template(p.toJSON()));
          });
        };
      })(this);
    };
...
(function() {
  ...
  Gentoo.Routers.Projects = (function(_super) {
    __extends(Projects, _super);
    ...
    Projects.prototype.initialize = function(projects) {
      this.projects = new Gentoo.Collections.Projects(projects);
      this.view = new Gentoo.Views.ProjectsIndex({
